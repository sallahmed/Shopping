...
import {
    NgChartsModule
} from '../features/ng-charts.module';
import {
    BaseChartComponent
} from '../features/common/base-chart.component';
/*import {
    LineComponent, LineSeriesComponent
} from '../features/line-chart';*/
import { LineComponent } from '@swimlane/ngx-charts/release/line-chart/line.component';
import { LineSeriesComponent } from '@swimlane/ngx-charts/release/line-chart/line-series.component';
import {
...
@Component({
  selector: 'app-combo-chart-component',
  template:  `
    <ngx-charts-chart
...
export class ComboChartComponent extends BaseChartComponent  {
  ...
  legendSpacing = 0;
  bandwidth;
  barPadding = 38; // barPadding = 8;  Augmenter écart entre bar
  clipPath: any;
