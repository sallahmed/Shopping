  ...
  template: `
    <svg:g>
      ...
      <svg:rect
        ...
        [attr.tooltipPlacement]="'right'"
        [attr.tooltipType]="'tooltip'"
        [attr.tooltipSpacing]="15"
        [attr.tooltipTemplate]="tooltipTemplate ? tooltipTemplate: defaultTooltipTemplate"
        [attr.tooltipContext]="anchorValues"
        [attr.tooltipImmediateExit]="true"
      />
    </svg:g>
  `,
