    ...
    <svg:g *ngIf="circle">
      <defs>
        <svg:g ngx-charts-svg-linear-gradient
          ...
          [attr.name]="gradientId"
          [attr.stops]="circle.gradientStops"
        />
      </defs>
      <svg:rect
      ...
      <svg:g ngx-charts-circle
        ...
        [attr.pointerEvents]="circle.value === 0 ? 'none': 'all'"
        [attr.data]="circle.value"
        [attr.classNames]="circle.classNames"
        ...
        [attr.tooltipTitle]="tooltipTemplate ? undefined : getTooltipText(circle)"
        [attr.tooltipTemplate]="tooltipTemplate"
        [attr.tooltipContext]="circle.data"
      />
    </svg:g>
  `,
