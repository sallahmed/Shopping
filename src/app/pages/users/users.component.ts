...
export class UsersComponent implements OnInit {
    ...
    public getListUsers(): void { //Perso
        this.listUsers = null; //for show spinner each time
        this.usersService.getListeUtilisateurs().subscribe(users => this.listUsers = users);
    }
